...
export function InventoryScreen() {
    ...
    return (_jsxs("div", { className: "screen", children: [_jsxs("header", { className: "screen-header", children: [_jsxs("div", { children: [_jsxs("h2", { children: ["Qu\u1EA3n l\u00FD ", _jsx("span", { children: "Kho h\u00E0ng" })] }), _jsxs("p", { children: [items.length, " nguy\u00EAn li\u1EC7u", lowStock.length > 0 ? ` · ⚠️ ${lowStock.length} sắp hết` : ""] })] }), _jsxs("div", { className: "header-actions", children: [_jsx("button", { className: "btn-secondary", onClick: () => setModal("import"), children: "\uD83D\uDCE5 Nh\u1EADp kho" }), _jsx("button", { className: "btn-secondary", onClick: () => setModal("export"), children: "\uD83D\uDCE4 Xu\u1EA5t kho" }), _jsx("button", { className: "btn-primary", onClick: () => { setModal("create"); setEditItem(undefined); }, children: "+ Th\u00EAm nguy\u00EAn li\u1EC7u" })] })] }), error && _jsx("div", { className: "alert-error", children: error }), lowStock.length > 0 && (_jsxs("div", { className: "low-stock-alert", children: ["\u26A0\uFE0F Nguy\u00EAn li\u1EC7u s\u1EAFp h\u1EBFt: ", lowStock.map(i => i.name).join(", ")] })), _jsxs("div", { className: "inv-tabs", children: [_jsx("button", { className: `inv-tab ${tab === "items" ? "active" : ""}`, onClick: () => setTab("items"), children: "Danh s\u00E1ch nguy\u00EAn li\u1EC7u" }), _jsx("button", { className: `inv-tab ${tab === "transactions" ? "active" : ""}`, onClick: () => setTab("transactions"), children: "L\u1ECBch s\u1EED giao d\u1ECBch" })] }), tab === "items" && (_jsxs(_Fragment, { children: [_jsx("input", { className: "search-input", placeholder: "\uD83D\uDD0D T\u00ECm nguy\u00EAn li\u1EC7u...", value: search, onChange: e => setSearch(e.target.value), style: { marginBottom: 12 } }), loading && _jsx("div", { className: "loading-state", children: "\u0110ang t\u1EA3i..." }), !loading && items.length === 0 ? (_jsxs("div", { className: "inv-empty-hero", children: [_jsx("div", { className: "inv-empty-icon", children: "\uD83D\uDCE6" }), _jsx("h3", { children: "Ch\u01B0a c\u00F3 nguy\u00EAn li\u1EC7u n\u00E0o trong kho" }), _jsx("p", { children: "B\u1EAFt \u0111\u1EA7u th\u00EAm nguy\u00EAn li\u1EC7u \u0111\u1EC3 theo d\u00F5i t\u1ED3n kho, c\u1EA3nh b\u00E1o s\u1EAFp h\u1EBFt v\u00E0 li\u00EAn k\u1EBFt v\u1EDBi th\u1EF1c \u0111\u01A1n sau n\u00E0y." }), _jsxs("div", { className: "inv-empty-actions", children: [_jsx("button", { type: "button", className: "btn-primary", onClick: () => { setModal("create"); setEditItem(undefined); }, children: "\uFF0B Th\u00EAm nguy\u00EAn li\u1EC7u \u0111\u1EA7u ti\u00EAn" }), _jsx("button", { type: "button", className: "btn-secondary", onClick: () => setModal("import"), children: "\uD83D\uDCE5 Nh\u1EADp t\u1EEB kho (phi\u1EBFu nh\u1EADp)" })] })] })) : (_jsx("div", { className: "staff-table-wrap", children: _jsxs("table", { className: "data-table", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "#" }), _jsx("th", { children: "T\u00EAn nguy\u00EAn li\u1EC7u" }), _jsx("th", { children: "\u0110\u01A1n v\u1ECB" }), _jsx("th", { children: "T\u1ED3n hi\u1EC7n t\u1EA1i" }), _jsx("th", { children: "T\u1ED1i thi\u1EC3u" }), _jsx("th", { children: "Tr\u1EA1ng th\u00E1i" }), _jsx("th", { children: "Thao t\u00E1c" })] }) }), _jsxs("tbody", { children: [filteredItems.map((item, idx) => {
                                            const isLow = item.currentStock <= item.minStock;
                                            return (_jsxs("tr", { className: isLow ? "row-warning" : "", children: [_jsx("td", { children: idx + 1 }), _jsx("td", { children: _jsx("strong", { children: item.name }) }), _jsx("td", { children: item.unit }), _jsx("td", { children: item.currentStock }), _jsx("td", { children: item.minStock }), _jsx("td", { children: _jsx("span", { className: `status-badge ${isLow ? "inactive" : "active"}`, children: isLow ? "⚠️ Sắp hết" : "✅ Đủ" }) }), _jsx("td", { children: _jsxs("div", { className: "row-actions", children: [_jsx("button", { type: "button", className: "btn-small", onClick: () => { setEditItem(item); setModal("edit"); }, children: "\u270F\uFE0F S\u1EEDa" }), _jsx("button", { type: "button", className: "btn-small danger", onClick: () => deleteItem(item), children: "\uD83D\uDDD1\uFE0F" })] }) })] }, item.id));
                                        }), filteredItems.length === 0 && !loading && items.length > 0 && (_jsx("tr", { children: _jsx("td", { colSpan: 7, className: "empty-cell", children: "Kh\u00F4ng c\u00F3 nguy\u00EAn li\u1EC7u kh\u1EDBp t\u00ECm ki\u1EBFm." }) }))] })] }) }))] })), tab === "transactions" && (_jsx("div", { className: "staff-table-wrap", children: _jsxs("table", { className: "data-table", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "#" }), _jsx("th", { children: "Nguy\u00EAn li\u1EC7u" }), _jsx("th", { children: "Lo\u1EA1i" }), _jsx("th", { children: "S\u1ED1 l\u01B0\u1EE3ng" }), _jsx("th", { children: "Ghi ch\u00FA" }), _jsx("th", { children: "Th\u1EDDi gian" })] }) }), _jsxs("tbody", { children: [transactions.map((tx, idx) => (_jsxs("tr", { children: [_jsx("td", { children: idx + 1 }), _jsx("td", { children: tx.itemName }), _jsx("td", { children: _jsx("span", { className: `tx-badge ${tx.type.toLowerCase()}`, children: tx.type === "IMPORT" ? "📥 Nhập" : tx.type === "EXPORT" ? "📤 Xuất" : "⚙️ Điều chỉnh" }) }), _jsx("td", { children: tx.quantity }), _jsx("td", { children: tx.note || "—" }), _jsx("td", { children: new Date(tx.createdAt).toLocaleString("vi-VN") })] }, tx.id))), transactions.length === 0 && (_jsx("tr", { children: _jsx("td", { colSpan: 6, className: "empty-cell", children: "Ch\u01B0a c\u00F3 giao d\u1ECBch n\u00E0o" }) }))] })] }) })), (modal === "create" || modal === "edit") && (_jsx(Modal, { title: modal === "create" ? "Thêm nguyên liệu" : "Sửa nguyên liệu", onClose: () => setModal(null), children: _jsx(ItemForm, { initial: editItem, onSave: () => { setModal(null); load(); }, onClose: () => setModal(null) }) })), modal === "import" && (_jsx(Modal, { title: "Nh\u1EADp kho", onClose: () => setModal(null), children: _jsx(TransactionForm, { items: items, type: "import", onSave: () => { setModal(null); load(); }, onClose: () => setModal(null) }) })), modal === "export" && (_jsx(Modal, { title: "Xu\u1EA5t kho", onClose: () => setModal(null), children: _jsx(TransactionForm, { items: items, type: "export", onSave: () => { setModal(null); load(); }, onClose: () => setModal(null) }) }))] }));
}
