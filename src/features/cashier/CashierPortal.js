...
// ─── Order Item list ───────────────────────────────────────────────────────────
function OrderItems({ items, menuItemNames }) {
    const billable = items.filter(i => i.billable && i.status !== "CANCELLED");
    return (_jsx("div", { className: "order-items", children: billable.map(item => (_jsxs("div", { className: "order-line", children: [_jsxs("span", { className: "item-qty", children: [item.quantity, "x"] }), _jsx("span", { className: "item-name", children: item.menuItemName || menuItemNames.get(item.menuItemId) || `Món #${item.menuItemId}` }), item.note && _jsxs("span", { className: "item-note", children: ["(", item.note, ")"] }), _jsx("span", { className: "item-subtotal", children: fmtVnd(item.subtotal) })] }, item.id))) }));
}
// ─── Payment Form ──────────────────────────────────────────────────────────────
function PaymentForm({ order, shiftId, onPaid }) {
    ...
    return (_jsxs("div", { className: "payment-form", children: [_jsxs("div", { className: "pay-section", children: [_jsx("h4", { children: "Ph\u01B0\u01A1ng th\u1EE9c thanh to\u00E1n" }), _jsxs("div", { className: "pay-methods", children: [_jsx("button", { className: `pay-method-btn ${method === "CASH" ? "active" : ""}`, onClick: () => setMethod("CASH"), children: "\uD83D\uDCB5 Ti\u1EC1n m\u1EB7t" }), _jsx("button", { className: `pay-method-btn ${method === "QR_CODE" ? "active" : ""}`, onClick: () => setMethod("QR_CODE"), children: "\uD83D\uDCF1 VNPay QR" }), _jsx("button", { className: `pay-method-btn ${method === "VNPAY_ATM" ? "active" : ""}`, onClick: () => setMethod("VNPAY_ATM"), children: "\uD83C\uDFE7 VNPay ATM" })] })] }), _jsxs("div", { className: "order-totals", children: [order.taxMode !== "NO_TAX" && order.taxAmount > 0 && (_jsxs(_Fragment, { children: [_jsxs("div", { className: "total-row subtotal-row", children: [_jsx("span", { children: "T\u1EA1m t\u00EDnh (tr\u01B0\u1EDBc thu\u1EBF)" }), _jsx("span", { children: fmtVnd(order.subtotalAmount) })] }), _jsxs("div", { className: "total-row tax-row", children: [_jsxs("span", { children: ["Thu\u1EBF (", (order.taxRateBps / 100).toFixed(0), "%)"] }), _jsx("span", { children: fmtVnd(order.taxAmount) })] })] })), _jsxs("div", { className: "total-row grand-total-row", children: [_jsx("span", { children: "T\u1ED5ng thanh to\u00E1n" }), _jsx("b", { children: fmtVnd(order.totalAmount) })] })] }), err && _jsx("div", { className: "form-err", children: err }), !payment ? (_jsx("button", { className: "btn-pay", onClick: createPayment, disabled: loading, children: loading
                    ? "Đang xử lý..."
                    : method === "VNPAY_ATM"
                        ? "🏧 Chuyển sang VNPay"
                        : "💳 Tạo thanh toán" })) : (_jsxs("div", { className: "payment-result", children: [method === "QR_CODE" && (_jsxs("div", { className: "qr-display", children: [_jsx("p", { className: "qr-label", children: "Qu\u00E9t m\u00E3 QR \u0111\u1EC3 thanh to\u00E1n VNPay" }), payment.qrContent || payment.payUrl ? (_jsx("div", { style: { display: "flex", justifyContent: "center", margin: "12px 0" }, children: _jsx(QRCodeSVG, { value: payment.qrContent || payment.payUrl || "", size: 200, level: "M", includeMargin: true }) })) : (_jsx("div", { className: "qr-placeholder", children: "Kh\u00F4ng c\u00F3 m\u00E3 QR" })), pollStatus && (_jsxs("div", { className: "poll-status", children: ["Tr\u1EA1ng th\u00E1i: ", _jsx("b", { children: pollStatus }), " \u2014 \u0110ang ki\u1EC3m tra m\u1ED7i 3 gi\u00E2y..."] })), payment.qrExpiresAt && (_jsxs("p", { className: "qr-expire", children: ["H\u1EBFt h\u1EA1n: ", fmtTime(payment.qrExpiresAt)] }))] })), method === "CASH" && (_jsxs("div", { className: "cash-confirm", children: [payment.taxMode !== "NO_TAX" && payment.taxAmount > 0 && (_jsxs("div", { className: "cash-breakdown", children: [_jsxs("div", { className: "cash-amount-row", children: [_jsx("span", { children: "Tr\u01B0\u1EDBc thu\u1EBF" }), _jsx("span", { children: fmtVnd(payment.subtotalAmount) })] }), _jsxs("div", { className: "cash-amount-row", children: [_jsxs("span", { children: ["Thu\u1EBF (", (payment.taxRateBps / 100).toFixed(0), "%)"] }), _jsx("span", { children: fmtVnd(payment.taxAmount) })] })] })), _jsxs("div", { className: "cash-amount", children: [_jsx("span", { children: "S\u1ED1 ti\u1EC1n thu" }), _jsx("b", { children: fmtVnd(payment.amount) })] }), _jsx("button", { className: "btn-pay success", onClick: onPaid, children: "\u2705 X\u00E1c nh\u1EADn \u0111\u00E3 thu ti\u1EC1n" })] })), staff?.role === "MANAGER" && (_jsx("button", { className: "btn-refund", onClick: refund, children: "\uD83D\uDD04 Ho\u00E0n ti\u1EC1n" }))] }))] }));
}
function ShiftScreen({ current, onShiftChange }) {
    ...
    const estimatedDiscrepancy = summary && Number.isFinite(actualAmt)
    ...
    return (_jsxs("div", { className: "screen", children: [_jsx("header", { className: "screen-header", children: _jsxs("div", { children: [_jsxs("h2", { children: ["Ca l\u00E0m vi\u1EC7c ", _jsx("span", { children: "Thu ng\u00E2n" })] }), _jsxs("p", { children: ["Nh\u00E2n vi\u00EAn: ", _jsx("strong", { children: staff.name }), " \u00B7 ID #", staff.id] })] }) }), err && _jsx("div", { className: "alert-error", style: { margin: "0 0 12px" }, children: err }), !current ? (_jsxs("div", { className: "stat-panel", children: [closeResult && (_jsxs("div", { className: "alert-success", style: { marginBottom: 16 }, children: [_jsxs("div", { children: ["\u2705 ", _jsxs("strong", { children: ["\u0110\u00E3 \u0111\u00F3ng ca #", closeResult.shiftId] })] }), _jsxs("div", { style: { marginTop: 8, display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }, children: [_jsxs("div", { className: "stat-card-mini", children: [_jsx("span", { className: "stat-label", children: "Ti\u1EC1n m\u1EB7t thu" }), _jsx("span", { className: "stat-value", children: fmtVnd(closeResult.cashRevenue) })] }), _jsxs("div", { className: "stat-card-mini", children: [_jsx("span", { className: "stat-label", children: "Chuy\u1EC3n kho\u1EA3n" }), _jsx("span", { className: "stat-value", children: fmtVnd(closeResult.transferRevenue) })] }), _jsxs("div", { className: `stat-card-mini ${closeResult.discrepancy !== 0 ? "stat-card-warning" : ""}`, children: [_jsx("span", { className: "stat-label", children: "Ch\u00EAnh l\u1EC7ch" }), _jsx("span", { className: "stat-value", children: fmtVnd(closeResult.discrepancy) })] })] }), closeResult.notes && (_jsxs("p", { style: { marginTop: 6, fontSize: 12, color: "#6b7280" }, children: ["Ghi ch\u00FA: ", closeResult.notes] }))] })), _jsx("h4", { children: "\uD83D\uDCD2 M\u1EDF ca m\u1EDBi" }), _jsx("p", { style: { marginBottom: 12, color: "#6b7280", fontSize: 14 }, children: "Qu\u1EF9 \u0111\u1EA7u ca l\u00E0 s\u1ED1 ti\u1EC1n m\u1EB7t c\u00F3 t\u1EA1i qu\u1EA7y khi b\u1EAFt \u0111\u1EA7u ca l\u00E0m vi\u1EC7c." }), _jsxs("div", { className: "form-group", children: [_jsx("label", { htmlFor: "opening-total", children: "S\u1ED1 ti\u1EC1n \u0111\u1EA7u ca (VND)" }), _jsx("input", { id: "opening-total", placeholder: "VD: 2.000.000", value: openingTotal, onChange: (ev) => setOpeningTotal(ev.target.value) })] }), _jsx("button", { type: "button", className: "btn-primary", disabled: loading, onClick: () => void openShift(), children: loading ? "Đang xử lý…" : "📒 Mở ca" })] })) : (_jsxs("div", { className: "stat-panel", children: [resumed && (_jsxs("div", { className: "alert-warning", style: { marginBottom: 16 }, children: ["\u26A0\uFE0F Phi\u00EAn tr\u01B0\u1EDBc ch\u01B0a k\u1EBFt ca \u2014 \u0111\u00E3 t\u1EF1 \u0111\u1ED9ng ti\u1EBFp t\u1EE5c ca #", current.id, "."] })), _jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }, children: [_jsx("span", { style: { fontSize: 28 }, children: "\uD83D\uDFE2" }), _jsxs("div", { children: [_jsxs("h4", { style: { margin: 0 }, children: ["Ca #", current.id, " \u0111ang ho\u1EA1t \u0111\u1ED9ng"] }), _jsx("p", { style: { margin: 0, color: "#6b7280", fontSize: 13 }, children: "Thanh to\u00E1n \u0111\u00E3 \u0111\u01B0\u1EE3c b\u1EADt cho ca n\u00E0y." })] })] }), _jsxs("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 20 }, children: [_jsxs("div", { className: "stat-card-mini", children: [_jsx("span", { className: "stat-label", children: "M\u1EDF l\u00FAc" }), _jsx("span", { className: "stat-value", children: fmtTime(current.openedAt) })] }), _jsxs("div", { className: "stat-card-mini", children: [_jsx("span", { className: "stat-label", children: "Qu\u1EF9 \u0111\u1EA7u ca" }), _jsx("span", { className: "stat-value", children: fmtVnd(current.openingTotal) })] })] }), _jsxs("div", { style: { marginBottom: 20 }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }, children: [_jsx("span", { style: { fontSize: 13, fontWeight: 600, color: "#374151" }, children: "\uD83D\uDCCA Doanh thu ca hi\u1EC7n t\u1EA1i" }), _jsx("button", { type: "button", className: "btn-small", onClick: () => void loadSummary(), disabled: summaryLoading, children: summaryLoading ? "Đang tải…" : summary ? "🔄 Cập nhật" : "Xem trước" })] }), summary ? (_jsxs("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }, children: [_jsxs("div", { className: "stat-card-mini", children: [_jsx("span", { className: "stat-label", children: "Ti\u1EC1n m\u1EB7t thu" }), _jsx("span", { className: "stat-value", children: fmtVnd(summary.cashRevenue) })] }), _jsxs("div", { className: "stat-card-mini", children: [_jsx("span", { className: "stat-label", children: "Chuy\u1EC3n kho\u1EA3n" }), _jsx("span", { className: "stat-value", children: fmtVnd(summary.transferRevenue) })] }), _jsxs("div", { className: "stat-card-mini", children: [_jsx("span", { className: "stat-label", children: "D\u1EF1 ki\u1EBFn trong k\u00E9t" }), _jsx("span", { className: "stat-value gold", children: fmtVnd(summary.expectedCash) })] })] })) : (_jsx("p", { style: { fontSize: 12, color: "#9ca3af" }, children: "Nh\u1EA5n \"Xem tr\u01B0\u1EDBc\" \u0111\u1EC3 ki\u1EC3m tra doanh thu tr\u01B0\u1EDBc khi k\u1EBFt ca." }))] }), _jsx("hr", { style: { margin: "0 0 18px", borderColor: "#e5e7eb" } }), _jsx("h4", { style: { marginBottom: 12 }, children: "K\u1EBFt ca" }), _jsx("p", { style: { marginBottom: 12, color: "#6b7280", fontSize: 14 }, children: "Nh\u1EADp s\u1ED1 ti\u1EC1n m\u1EB7t th\u1EF1c t\u1EBF trong k\u00E9t. N\u1EBFu c\u00F3 ch\u00EAnh l\u1EC7ch, b\u1EAFt bu\u1ED9c ph\u1EA3i ghi l\u00FD do." }), _jsxs("div", { className: "form-group", children: [_jsx("label", { htmlFor: "closing-total", children: "S\u1ED1 ti\u1EC1n m\u1EB7t th\u1EF1c t\u1EBF cu\u1ED1i ca (VND) *" }), _jsx("input", { id: "closing-total", placeholder: "VD: 5.000.000", value: closingTotal, onChange: (ev) => setClosingTotal(ev.target.value) })] }), summary && estimatedDiscrepancy !== null && (_jsx("div", { style: {
                            padding: "8px 12px",
                            borderRadius: 8,
                            marginBottom: 12,
                        ...
                        }, children: estimatedDiscrepancy === 0
                            ? "✅ Không có chênh lệch — có thể kết ca không cần ghi chú."
                            : `⚠️ Chênh lệch dự kiến: ${fmtVnd(estimatedDiscrepancy)} — bắt buộc nhập lý do bên dưới.` })), _jsxs("div", { className: "form-group", children: [_jsxs("label", { htmlFor: "closing-notes", children: ["L\u00FD do sai s\u1ED1 / Ghi ch\u00FA k\u1EBFt ca", estimatedDiscrepancy !== null && estimatedDiscrepancy !== 0 && (_jsx("span", { style: { color: "#ef4444", marginLeft: 4 }, children: "*" }))] }), _jsx("textarea", { id: "closing-notes", rows: 3, placeholder: "VD: Kh\u00E1ch tr\u1EA3 d\u01B0 50.000\u0111 v\u00E0 kh\u00F4ng l\u1EA5y l\u1EA1i; ho\u1EB7c kh\u00F4ng c\u00F3 sai s\u1ED1...", value: closingNotes, onChange: (ev) => setClosingNotes(ev.target.value), style: {
                                    width: "100%",
                                    padding: "8px 12px",
                                    borderRadius: 8,
                                    ...
                                    resize: "vertical",
                                    fontFamily: "inherit",
                                } })] }), _jsx("button", { type: "button", className: "btn-danger", disabled: loading, onClick: () => void closeShiftNow(), children: loading ? "Đang xử lý…" : "🔒 Kết ca" })] }))] }));
}
function InvoiceScreen({ currentShift }) {
    const [orders, setOrders] = useState([]);
    const [selected, setSelected] = useState(null);
    const [loading, setLoading] = useState(false);
    const [menuItemNames, setMenuItemNames] = useState(new Map());
    useEffect(() => {
...
function HistoryScreen() {
    ...
    return (_jsxs("div", { className: "screen", children: [_jsxs("header", { className: "screen-header", children: [_jsxs("div", { children: [_jsxs("h2", { children: ["L\u1ECBch s\u1EED ", _jsx("span", { children: "Giao d\u1ECBch" })] }), _jsx("p", { children: totalElements > 0
                                    ...
                                    : "Chưa có giao dịch" })] }), _jsx("button", { className: "btn-secondary", onClick: () => void load(page, size), children: "\uD83D\uDD04 L\u00E0m m\u1EDBi" })] }), error && _jsx("div", { className: "alert-error", children: error }), loading && _jsx("div", { className: "loading-state", children: "\u0110ang t\u1EA3i..." }), _jsx("div", { className: "staff-table-wrap", children: _jsxs("table", { className: "data-table", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "\u0110\u01A1n #" }), _jsx("th", { children: "B\u00E0n" }), _jsx("th", { children: "S\u1ED1 m\u00F3n" }), _jsx("th", { children: "T\u1ED5ng ti\u1EC1n" }), _jsx("th", { children: "Thanh to\u00E1n l\u00FAc" }), _jsx("th", { children: "H\u00F3a \u0111\u01A1n" }), staff?.role === "MANAGER" && _jsx("th", { children: "Ho\u00E0n ti\u1EC1n" })] }) }), _jsxs("tbody", { children: [orders.map(order => (_jsxs("tr", { children: [_jsxs("td", { children: ["#", order.id] }), _jsx("td", { children: order.tableCode || `Bàn ${order.tableId}` }), _jsx("td", { children: order.items?.length || 0 }), _jsx("td", { className: "gold", children: fmtVnd(order.totalAmount) }), _jsx("td", { children: order.paidAt ? fmtTime(order.paidAt) : "—" }), _jsx("td", { children: _jsx(InvoiceExport, { orderId: order.id, tableLabel: order.tableCode || `Bàn ${order.tableId}`, compact: true }) }), staff?.role === "MANAGER" && (_jsx("td", { children: _jsx("button", { className: "btn-small danger", onClick: () => {
                                                    Modal.confirm({
