...
import { BarChartOutlined, LineChartOutlined, AppstoreOutlined, TableOutlined, TeamOutlined, InboxOutlined, RobotOutlined, } from "@ant-design/icons";
...
export function AdminPortal() {
    ...
    const navItems = [
        ...
        { id: "revenue", label: "Báo cáo DT", icon: _jsx(LineChartOutlined, {}) },
    ...
    return (_jsxs(PortalLayout, { title: "QU\u1EA2N TR\u1ECA H\u1EC6 TH\u1ED0NG", subtitle: "MANAGER", navItems: navItems, activeTab: tab, onTabChange: (t) => setTab(t), children: [tab === "analytics" && _jsx(AnalyticsScreen, {}), tab === "revenue" && _jsx(RevenueScreen, {}), tab === "menu" && _jsx(MenuScreen, {}), tab === "tables" && _jsx(TablesScreen, {}), tab === "staff" && _jsx(StaffScreen, {}), tab === "inventory" && _jsx(InventoryScreen, {}), tab === "ai" && _jsx(AIScreen, {})] }));
}
