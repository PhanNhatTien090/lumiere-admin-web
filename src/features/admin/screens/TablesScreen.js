...
function QrPanel({ table, onClose }) {
    ...
    useEffect(() => { loadQr(); }, []);
    return (_jsxs(Modal, { title: `QR Code — Bàn ${table.tableCode}`, onClose: onClose, children: [loading && _jsx("div", { className: "loading-state", children: "\u0110ang t\u1EA3i QR..." }), err && _jsx("div", { className: "form-err", children: err }), qr && (_jsxs("div", { className: "qr-panel", children: [qr.qrImageUrl ? (_jsx("img", { src: qr.qrImageUrl, alt: "QR Code", className: "qr-img" })) : (_jsxs("div", { className: "qr-placeholder", children: [_jsx("p", { children: "QR Content:" }), _jsx("code", { children: qr.qrContent })] })), qr.expiresAt && (_jsxs("p", { className: "qr-expire", children: ["H\u1EBFt h\u1EA1n: ", fmtDateTime(qr.expiresAt)] })), _jsxs("div", { className: "form-actions", style: { marginTop: 16 }, children: [_jsx("button", { className: "btn-danger", onClick: rotateQr, disabled: rotating, children: rotating ? "Đang xử lý..." : "🔄 Xoay QR mới" }), _jsx("button", { className: "btn-secondary", onClick: onClose, children: "\u0110\u00F3ng" })] })] }))] }));
}
